...
/**
 * Maketplace service class
 * 
 * @author CISEL Vincent <vcisel@eurodns.com>
 * 
 */
public class MaketplaceService extends Service {

	public MaketplaceService(Authenticator auth, String name) {
		super(auth, "marketplace", name);
	}
